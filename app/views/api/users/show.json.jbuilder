...
json.followers @user.followers.each do |follow|
    ...
    json.followed follow.follower.followers.any? { |follower| follower.follower_id == @user.id }
end
json.followees @user.followees.each do |follow|
    ...
    json.followed follow.followee.followers.any? { |follower| follower.follower_id == @user.id }
end
